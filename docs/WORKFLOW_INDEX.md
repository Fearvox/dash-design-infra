...
||||||||||| Creator warm-paper page geometry diagnostic | [`examples/creator-warm-paper-page-geometry-diagnostic.html`](../examples/creator-warm-paper-page-geometry-diagnostic.html) | HTML artifact | `bun measure:check -- examples/creator-warm-paper-page-geometry-diagnostic.html --canvas=1684x1191` and `bun print:render -- examples/creator-warm-paper-page-geometry-diagnostic.html /tmp/dash-creator-warm-paper-page-geometry-diagnostic.pdf --canvas=1684x1191` | Page geometry audit: 6 warm-paper surfaces show 3 role-distinguished patterns (page padding, inner container, page::before frame). Outer padding 44–70px range; inner 40–70px. Closest pair: motion-storyboard 52px / prompt-dna 56px (4px drift). Token candidates `--pad-page`, `--pad-shell`, `--pad-frame` identified but require creator/design verdict on whether warm-paper family should be uniform (token + 56px) or rhythm-varying (signature + 3-patterns). Fixed canvas fits. | Public-safe diagnostic artifact; no surface edits |
