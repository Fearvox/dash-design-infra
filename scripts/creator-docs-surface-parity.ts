 ...
 * retained mutations, examples/creator-*.html files, multi-surface-proof
 * SURFACES list, and package.json script entries.
...
// ── 8. WORKFLOW_INDEX creator rows should have corresponding surface files ──
