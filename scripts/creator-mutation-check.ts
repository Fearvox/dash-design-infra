...
for (const command of ['creator:mutation-check', 'creator:poster-check', 'creator:prompt-dna-check', 'creator:evolution-check', 'creator:capsule-check', 'docs:links', 'security:scan', 'hackathon:score']) {
