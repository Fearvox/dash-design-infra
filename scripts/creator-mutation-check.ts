...
for (const command of ['creator:mutation-check', 'creator:poster-check', 'creator:prompt-dna-check', 'creator:motion-storyboard-check', 'creator:social-card-check', 'creator:evolution-check', 'creator:capsule-check', 'docs:links', 'security:scan', 'hackathon:score']) {
